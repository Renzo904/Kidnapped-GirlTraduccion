    ...
    window:
        ...
        if who is not None:
            ...
            window:
                id "namebox"
                style "namebox"
                text who id "who" outlines [ (absolute(1), "#000000", absolute(0), absolute(0)) ]
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    if config.has_voice:
                        label _("Громкость голоса Алисы")

                        hbox:
                            bar value Preference("voice volume")

                            if config.sample_voice:
                                textbutton _("Тест голоса") action Play("voice", config.sample_voice)
...
screen mods():
    ...
    use game_menu(_("Настройки"), scroll="viewport"):
        ...
        vbox:
            ...
            textbutton "Return" action Return() xalign 0.99 yalign 0.99
            ...
            python:
                ...
                for mod in mods:
                    ui.textbutton(mods[mod], action=Start(mod))
...
screen messenge(txt, xa = 0.5, ya = 0.5):
    text txt:
        xalign xa
        yalign ya
        font "segoeprb.ttf"
...
screen titles(speed = 10):
    frame:
        ...
        vbox:
            ...
            spacing 200
            vbox:
                text _("{color=#1E90FF}{b}Идея и сценарий:{/b}{/color}\n  TroyHolman") size 40
            vbox:
                text _("{color=#1E90FF}{b}Художник персонажей:{/b}{/color}\n  burburart") size 40
            vbox:
                text _("{color=#1E90FF}{b}Художник фонов:{/b}{/color}\n  DreaML") size 40
            vbox:
                text _("{color=#1E90FF}{b}Дизайнер интерфейса:{/b}{/color}\n  Slegarchik") size 40
            vbox:
                text _("{color=#1E90FF}{b}Композиторы:{/b}{/color}\n  Ito Emily\n  MyEmptyRoom\n  epileptic kid") size 40
            vbox:
                text _("{color=#1E90FF}{b}Исполнитель песни:{/b}{/color}\n  kotori") size 40
            vbox:
                text _("{color=#1E90FF}{b}Озвучка Алисы:{/b}{/color}\n  EnoRu") size 40
            vbox:
                text _("{color=#1E90FF}{b}Редактор:{/b}{/color}\n  LisVal (Валерий Гайлюн)") size 40
            vbox:
                text _("{color=#1E90FF}{b}Корректоры:{/b}{/color}\n  Anastasiazogue\n  Diana") size 40
            vbox:
                text _("{color=#1E90FF}{b}Перевод на английский:{/b}{/color}\n   Catherine Chu (Екатерина Чулкова)") size 40
            vbox:
                text _("{color=#1E90FF}{b}Редактор английского:{/b}{/color}\n   Elliot (TheVoid42)") size 40
            vbox:
                text _("{color=#1E90FF}{b}Кодер:{/b}{/color}\n  TroyHolman") size 40
            vbox:
                text _("{color=#1E90FF}{b}Консультанты и помощь в кодинге:{/b}{/color}\n  RUZURA Interactive\n  Dopneer") size 40
            vbox:
                text _("{color=#1E90FF}{b}Благодарности:{/b}{/color}\n  Лена Подыкалова\n  Ви\n  Максим Куракин\n  Илья Лазарев\n  <Animer33>\n  Михаил Свинобой\n  Wise_Owl\n  StuG_54\n  Dadyarri\n  GyN\n  Мира Зубец\n  DemetriX") size 40
        at for_titles(speed)
    timer speed action Return()

transform for_titles(speed):
    ypos 1200
